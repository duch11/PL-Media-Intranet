...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='passwords are stored in SHA1 format.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'asdqweasd','asd@test.tech','John','Doe','emp',0),(2,'mehhahameh','qwe@test.tech','Dohn','Joe','par',0),(3,'123','jonas@holm.tech','Jonas','Holm','emp',1);
...
-- Dump completed on 2017-11-17 10:48:00
