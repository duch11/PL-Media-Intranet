...
CREATE TABLE `child` (
  ...
  `nap` int(11) NOT NULL,
  `other_info` varchar(200) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `child` VALUES (1,'baby','infant','2015-11-01','Hjemmehosdigselv 12, 2 th, 2500',0,'none',1);
...
-- Dump completed on 2017-11-02 13:19:00
