...
INSERT INTO `child` VALUES (1,'Claus','Bove','2015-11-01','Hjemmehosdigselv 12, 2 th, 2500'),(2,'David','Ema','1890-11-01','Hjemmehosdigselv 12, 2 th, 2500'),(3,'Faisal','Jarkass','2017-12-05','Hjemmehosdigselv 12, 2 th, 2500'),(4,'Lille Peter','Edderkohp','1929-04-11','Spindelvej 15');
...
INSERT INTO `child_allergen` VALUES (1,1),(1,2),(2,1),(3,4);
...
INSERT INTO `child_wing` VALUES (1,1),(2,3),(3,2);
...
INSERT INTO `group` VALUES (1,'Ledelsen','Her er ledelsen!'),(2,'Ansatte','De ansatte er bare slaver');
...
INSERT INTO `parent_user_child` VALUES (325,1),(325,2),(326,1),(326,2);
...
INSERT INTO `permission` VALUES (7,'Create employee','Adds a new employee to the system.'),(12,'Create parent','Adds a new parent to the system.'),(14,'Read all parents','Shows all existing parents. '),(22,'Create child','Adds a new child to the System.'),(24,'Read all children','Shows all existing child.'),(27,'Edit Settings','Can he edit settings?'),(28,'Edit permissions','The ability to change others permissions'),(29,'Edit own permissions','The ability to change ones own permissions');
...
INSERT INTO `wing` VALUES (1,'Blå','Det gode sted for venstre børn'),(2,'Grøn','Alternativ grønkål!'),(3,'Bæbrun','Afrika');
...
-- Dump completed on 2017-12-12 11:40:08
